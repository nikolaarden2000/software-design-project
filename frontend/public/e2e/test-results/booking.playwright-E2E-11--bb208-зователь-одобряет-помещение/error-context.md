...
- Name: booking.playwright.spec.js >> E2E-11. Суперпользователь одобряет помещение
- Location: booking.playwright.spec.js:258:1
...
Locator: locator('[data-room-id="16"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-room-id="16"]')
